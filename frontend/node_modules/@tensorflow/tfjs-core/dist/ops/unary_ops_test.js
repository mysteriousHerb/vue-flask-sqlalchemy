...
jasmine_util_1.describeWithFlags('isNaN', test_util_1.ALL_ENVS, function () {
    it('basic', function () {
...
jasmine_util_1.describeWithFlags('isInf', test_util_1.ALL_ENVS, function () {
    it('basic', function () {
        var a = tf.tensor1d([NaN, Infinity, -Infinity, 0, 1]);
        var r = tf.isInf(a);
        expect(r.dtype).toEqual('bool');
...
jasmine_util_1.describeWithFlags('isFinite', test_util_1.ALL_ENVS, function () {
    it('basic', function () {
        var a = tf.tensor1d([NaN, Infinity, -Infinity, 0, 1]);
        var r = tf.isFinite(a);
        expect(r.dtype).toEqual('bool');
