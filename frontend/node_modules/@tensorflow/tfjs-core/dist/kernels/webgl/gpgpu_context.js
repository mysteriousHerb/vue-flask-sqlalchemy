...
var GPGPUContext = /** @class */ (function () {
    ...
    Object.defineProperty(GPGPUContext.prototype, "debug", {
        get: function () {
            return environment_1.ENV.get('DEBUG');
        },
        enumerable: true,
        configurable: true
    });
    ...
    GPGPUContext.prototype.getQueryTimerExtension = function () {
        if (this.disjointQueryTimerExtension == null) {
            this.disjointQueryTimerExtension =
                webgl_util.getExtensionOrThrow(this.gl, this.debug, environment_1.ENV.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION') === 2 ?
